...
- `subagent_type`: `poteto-research` on OpenCode, or the host's configured investigator agent elsewhere
...
- `subagent_type`: `poteto-research` on OpenCode, or the host's configured synthesizer agent elsewhere
